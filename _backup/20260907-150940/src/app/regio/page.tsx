...
export const metadata: Metadata = {
  ...
  description:
    "HaagVast is actief in Den Haag, Delft, Voorburg, Leidschendam, Rijswijk, Wassenaar, Zoetermeer, Pijnacker-Nootdorp, Midden-Delfland en Westland. Bekijk de mogelijkheden voor het verkopen van uw woning in regio Haaglanden.",
