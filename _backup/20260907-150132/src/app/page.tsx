...
export const metadata: Metadata = {
  ...
  description:
    "HaagVast bekijkt woningen rechtstreeks van eigenaren in Den Haag, Voorburg, Leidschendam, Rijswijk en Wassenaar. Ook kluswoningen en woningen die modernisering nodig hebben.",
  ...
  return (
    <>
      <Hero
        ...
        description="HaagVast bekijkt woningen rechtstreeks van eigenaren in Den Haag, Voorburg, Leidschendam en omgeving. Ook wanneer de woning verouderd is, renovatie nodig heeft of eerst verduurzaamd moet worden."
        benefits={[
          {
      ...
      <Benefits
        ...
        description="Niet iedere woning hoeft eerst volledig verkoopklaar gemaakt te worden. HaagVast kijkt naar de huidige staat Ã©n naar de mogelijkheden van de woning."
        items={[
          {
            icon: "hammer",
      ...
      <RegionLinks
        ...
        title="Lokaal gericht op Den Haag en omgeving"
        description="Bekijk de lokale pagina voor uw woonplaats. Iedere regio bevat eigen informatie over woningtypen, buurten en verkoopsituaties."
      ...
      <Faq
        ...
        items={[
          ...
          },
          {
            ...
            answer: (
              <p>
                De focus ligt op regio Haaglanden, waaronder Den Haag, Voorburg,
                Leidschendam, Rijswijk en Wassenaar. Woningen in de directe
                omgeving kunnen eveneens worden aangemeld.
              </p>
            ),
          },
          {
          ...
          },
          {
            ...
            answer: (
              <p>
                ...
                notariÃ«le overdracht uiteraard wel noodzakelijk.
              </p>
            ),
          },
          {
