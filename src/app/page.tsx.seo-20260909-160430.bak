...
export const metadata: Metadata = {
  ...
  description:
    "HaagVast bekijkt woningen in heel Haaglanden: Den Haag, Delft, Voorburg, Leidschendam, Rijswijk, Wassenaar, Zoetermeer, Pijnacker-Nootdorp, Midden-Delfland en Westland. Ook Voorschoten behoort tot het directe werkgebied. Ook kluswoningen en woningen die modernisering nodig hebben.",
